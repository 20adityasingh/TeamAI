...
import { Plus, LogOut, Search, Folder, Loader2, MoreVertical, Trash, Download, Edit, Crown, Sparkles } from "lucide-react";
...
export function ProjectsDashboard() {
    ...
    // Subscription state for plan badge
                ...
                <div className="container flex h-14 max-w-screen-2xl items-center justify-between px-4 sm:px-8">
                    <div className="flex items-center gap-2 font-bold text-lg">
                        <div className="w-8 h-8 rounded-lg flex items-center justify-center">
                            <img src="/favicon.png" alt="TeamAI Logo" className="w-6 h-6 object-contain" />
                        </div>
                        TeamAI
                    </div>
                    <div className="flex items-center gap-3">
                        <InviteNotification onInviteAccepted={fetchProjects} />
                        {/* Plan Badge */}
                        {subscription?.plan && (() => {
                            ...
                            return (
                                <div className={cn(
                                    ...
                                    {isUltimate && <Sparkles className="w-3 h-3" />}
